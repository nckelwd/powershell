...
$properties = "Enabled", "employeeID", "GivenName", "surname", "EmailAddress", "manager", "Department", "Title", "samAccountName", "whenCreated", "employeeType", "Company"
...
$exp | Export-csv -path "C:\Scripts\SOX_A03_ADUserReport_$date.csv" -NoTypeInformation